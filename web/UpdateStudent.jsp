            ...
            <div class="bodyform-left">
                ...
                <div class="bodyform-right">
                    ...
                    <%
                        ...
                        Student stdInfor = dao.getStudentInfor(id);
                        request.setAttribute("stdInfor", stdInfor);
                    %>
                            ...
                            <table border="0" style="background-color: whitesmoke">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="rollnumber" value="${stdInfor.rollnumber}" readonly/></td>
                                    </tr>
                                    <tr>
                                        <th style="background: #6B90DA">Name: </th>
                                        <td><input type="text" name="name" value="${stdInfor.name}" /></td>
                                    </tr>
                                    <tr>
                                        <th style="background: #6B90DA">Username: </th>
                                        <td><input type="text" name="username" value="${stdInfor.username}" readonly/></td>
                                    </tr>
                                    <tr>
                                        <th style="background: #6B90DA">Email Address: </th>
                                        <td><input type="text" name="email" value="${stdInfor.email}" /></td>
                                    </tr>
                                    <tr>
                                        <th style="background: #6B90DA">Gender: </th>
                                        <td>
                                            <input type="radio" name="gender" value="1" ${stdInfor.gender == true ? "checked":""}/>Male
                                            <input type="radio" name="gender" value="0" ${stdInfor.gender == false ? "checked":""}/>Female
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="background: #6B90DA">Date of Birth: </th>
                                        <td><input type="text" name="dob" value="${stdInfor.dob}" /></td>
                                    </tr>
