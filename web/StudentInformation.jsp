                ...
                <div class="bodyform-right">
                    <div class="tableAttendance" style="padding-left: 300px; margin-top: -200px">
                        <form action="studentInformation" method="POST">
                            <table border="1">
                                <form action="classMember" method="POST">
                                    <thead>
                                        <tr>
                                            <th style="background: #6B90DA">Student Name</th>
                                            <th style="background: #6B90DA">Student ID</th>
                                    ...
                                    <tbody style="background-color: whitesmoke">
                                        <c:forEach items="${listMember}" var="listMember">
                                            <tr>
                                                ...
                                                <td>${listMember.rollNumber}</td>
                                                <td><a class="btn btn-primary" href="UpdateStudent.jsp?studentID=${listMember.rollNumber}" role="button" style="border: 0px solid black; font-size: 10px; font-weight: bold; text-decoration: none;">Update</a></td>
                                                <td><a class="btn btn-primary" href="deleteStudent?studentID=${listMember.rollNumber}" onclick="showMess(${listMember.rollNumber})" role="button" style="border: 0px solid black; font-size: 10px; font-weight: bold; text-decoration: none;">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </form>
