...
public class StudentSchedule extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //---------------------------------------------------------------------------------------------------------
        List<ScheduleDetail> listStdSchdDetail = new ArrayList<>();
        for (Dates o : listDates) {
            List<ScheduleDetail> list1 = dao.getStudentScheduleDetail(user, o.getDateTime());
            for (ScheduleDetail o1 : list1) {
                listStdSchdDetail.add(o1);
            }
        }
        request.setAttribute("listStdSchdDetail", listStdSchdDetail);
